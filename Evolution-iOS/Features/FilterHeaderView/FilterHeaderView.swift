...
class FilterHeaderView: UIView {
    ...
    override func awakeFromNib() {
        ...
        let text = concatText(texts: formatterColor(color: UIColor.darkGray, text: "Filtered by: "),
                              formatterColor(color: UIColor.darkText, text: "All Statuses"))
    ...
    func updateFilterButton(status: [StatusState]) {
        ...
        let text = concatText(texts: formatterColor(color: UIColor.darkGray, text: "Filtered by: "),
                              formatterColor(color: UIColor(hex: 0xFF0088CC, alpha: 1.0), text: label))
